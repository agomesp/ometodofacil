...
:   EasyPeasy is open source and written in R Markdown. If you notice an improvement, it's very easy to change and you can find a [video guide on how to do so here](). 

Translate it!

:   It is impossible to express my unbelievable gratitude that people are willing to translate this book and help free others. Here's a [comprehensive video guide on setting up RStudio and publishing a translation.]()
...
Otherwise, if you're looking for something shorter, my favourite piece of text at current is [Exiting Modernity](https://www.meta-nomad.net/exiting-modernity/). If you take anything from this section, it's that you should read this document. Be warned -- it's quite a confronting document, but it's an enlightening experience if you let it be one.
